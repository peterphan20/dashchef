...
const CreateKitchen = () => {
	...
	return (
		<div className="bg-gray-100 w-full h-full min-h-screen lg:py-10">
			<div className="px-4 pt-10 pb-14 w-full h-full lg:bg-gray-200 lg:border lg:border-gray-300 lg:py-10 lg:px-20 lg:mx-auto lg:max-w-5xl lg:w-1/4 xl:w-1/3 lg:max-w-2xl">
